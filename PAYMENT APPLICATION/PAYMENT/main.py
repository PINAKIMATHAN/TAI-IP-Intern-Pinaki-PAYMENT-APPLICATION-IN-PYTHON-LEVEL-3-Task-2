...
# Label widget
Label(f1, text='NAME', font=f).grid(row=0, column=0, sticky=W)
Label(f1, text='AMOUNT', font=f).grid(row=1, column=0, sticky=W)
...
# Treeview widget
tv = ttk.Treeview(f2, columns=(1, 2, 3, 4), show='headings', height=12)
tv.pack(side="left")

# add heading to treeview
tv.column(1, anchor=CENTER, stretch=YES, width=70)
